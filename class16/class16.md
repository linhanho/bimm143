...
Looks like ther is an extra ‘length’ column in our countData that we
need to remove
...
Make an input vector of our number quantity of interest (i.e. fold
...
We use the KEGG pathway ID from our top hit along with our `foldrange`
