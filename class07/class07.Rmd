...
These are the functions, look here
```{r}
#Functions
...
#To find what elements of x exist in y
x %in% y

```

```{r}
#Only returning the x that are TRUE (i.e. are also found in y)
x[x %in%y ]
...
#Cleaning it up by assigning new variables
...
gene_intersect4(df1, df2, gene.colname)
